# -*- coding: utf-8 -*-
"""Тесты сжатия видео для веба (FR-SITE25, SPEC-SITE.md).
...
# ── FR-SITE25: размер задаётся кратностью, а не только качеством ─────────
...
# ── FR-SITE25: быстро открывается с мобильного ───────────────────────────
