...
восемнадцать сцен на дорожку 155 c, значков в веере стало по четыре
...
_DURATION = 155.6          # 02:35 — длина дорожки
_LAYER = 157.4             # слой длиннее: хвост держит шапку
_WORDS = 317               # столько слов в озвучке
_SCENES = 18
...
def test_layers_are_here_and_long_enough():
    ...
    assert "var DURATION = 157.4" in _html(), "длина ролика на странице разошлась со слоем"
