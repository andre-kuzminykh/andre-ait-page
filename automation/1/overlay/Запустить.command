...
#
# Зачем сервер: сборка «обложка + ролик» идёт в веб-воркере, а воркеры и
# .wasm браузер из file:// не пускает — это его политика безопасности,
# обойти её нельзя. Из http://127.0.0.1 всё работает.
#
