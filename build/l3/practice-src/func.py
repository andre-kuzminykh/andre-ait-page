...
with sync_playwright() as p:
    ...
    pg.click('.copy-code[data-copy="prompt-prompts"]'); pg.wait_for_timeout(300)
    ...
    clip = pg.evaluate("() => navigator.clipboard.readText()")
    print('prompt 2 copied plain:', clip.startswith('Ты — архитектор ИИ-систем'), '<b>' in clip, '-->' in clip)
    # case-nav
