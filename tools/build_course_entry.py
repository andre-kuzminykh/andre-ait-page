...
<style>
  ...
  *, *::before, *::after{ box-shadow:none !important; text-shadow:none !important; }
  ...
  /* ===== Блоки страницы =====
     Каждый блок занимает экран целиком, но это обычная прокрутка: никакого
     перехвата колеса и свайпа. Так страница ведёт себя предсказуемо на любом
     устройстве и ничего не «залипает». */
  ...
  @media print{
    .panel{min-height:auto;page-break-after:always}
...
{{SKILL_ITEMS}}
  ...
  <script>
    ...
    /* ===== Плавное появление блоков при прокрутке ======================
       ...
       экрана, а «Листайте вниз» плавно уводит к следующему блоку. */
    (function(){
