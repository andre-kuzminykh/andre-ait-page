...
NUMERALS = [
    # Заголовок первого слайда пишем цифрами. Имена плиток владелец задал
    # словами («Выбрать одного из ста», «Финансы вне сотни») — их не трогаем.
    ("Сто ИИ-сотрудников", "100 ИИ-сотрудников"),
]
