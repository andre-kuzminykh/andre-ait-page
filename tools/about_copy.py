...
EN = {
    ...
    "c3_head": "Not a Straight Line",
    "c3_p1": ("My path into technology was not a straight line. As a teenager, I earned money "
              "wherever I could:"),
    "c3_facts": [
        ("fa-pen-nib", "Wrote for a <strong>computer magazine</strong>"),
        ("fa-helmet-safety", "Worked <strong>construction jobs</strong>"),
        ("fa-truck-ramp-box", "<strong>Unloaded trucks</strong>"),
        ("fa-broom", "<strong>Cleaned basements</strong>"),
    ],
    ...
    "e1_facts": [
        ("fa-circle-check", "<strong>Bachelor’s degree in Business Informatics</strong> — Far Eastern Federal University"),
        ("fa-circle-check", "<strong>Master’s degree in Business Informatics</strong> — Higher School of Economics, after moving to Moscow"),
        ("fa-circle-check", "<strong>Diploma</strong> from the International Institute of Business Analysis"),
    ],

    "e2_head": "Research and Teaching",
    "e2_p1": ("Then came postgraduate research in AI and data analysis — and teaching at "
              "universities myself."),
    "e2_p2": ("During those years, I won machine-learning competitions and the National Olympiad "
              "in Business Informatics."),
    "e2_note": "University gave me the foundation. The next step was to test it against real business.",
    ...
    "s2_facts": [
        ...
        ("fa-bolt", "Built an <strong>AI digital twin of the power grid</strong> that detected electricity losses"),
    ...
    "s2_stat": ("200K+", "One of those startups became <strong>Product of the Day</strong> and "
                         "<strong>Product of the Week</strong> on Product Hunt and grew to more than "
                         "200,000 users."),

    "s3_head": "One Person, a Whole Company",
    "s3_p1": ("Over the years, I learned how to manage teams of engineers, launch products and turn "
    ...
    "s3_p3": ("I started learning how to create products and launch businesses without building a "
              "traditional team. That completely changed the way I thought about entrepreneurship."),
    ...
    "x1_cards": [
        ...
        ("fa-bolt-lightning", "Startups", "Could move incredibly fast, but with fewer resources they "
                                          "could not turn every idea into reality.", "o"),
    ],
    ...
    "x2_p1": ("I began working with both. I advised startups and large companies on AI strategy, "
              "AI product development and AI transformation."),
    ...
    "x3_p1": ("But consulting alone could never scale far enough. There is only one of me, and I "
              "cannot personally work with every entrepreneur or company that wants to transform."),
    "x3_p2": ("So I started turning my experience into a system: a methodology that diagnoses a "
              "business, finds where AI can create real value and turns that into an AI strategy "
    ...
    "m1_p1": ("A new economy needs more than technology: new skills, new roles and new ways of "
              "working."),
    ...
    "m2_p1": ("Education, research, technology, products and business transformation are not "
              "separate directions for me. They are parts of the same ecosystem."),
...
RU = {
    ...
    "c3_head": "Путь не был прямым",
    "c3_p1": "Мой путь в технологии не был прямым. Подростком я зарабатывал как мог:",
    "c3_facts": [
        ("fa-pen-nib", "Писал статьи для <strong>компьютерного журнала</strong>"),
        ("fa-helmet-safety", "Работал <strong>на стройках</strong>"),
        ("fa-truck-ramp-box", "<strong>Разгружал фуры</strong>"),
        ("fa-broom", "<strong>Чистил подвалы</strong>"),
    ],

    "e1_head": "От образования к ИИ",
    "e1_lead": "Образование стало для меня способом двигаться вперёд.",
    "e1_facts": [
        ("fa-circle-check", "<strong>Бакалавр по бизнес-информатике</strong> — Дальневосточный федеральный университет"),
        ("fa-circle-check", "<strong>Магистр по бизнес-информатике</strong> — Высшая школа экономики, после переезда в Москву"),
        ("fa-circle-check", "<strong>Диплом</strong> Международного института бизнес-анализа"),
    ],

    "e2_head": "Наука и преподавание",
    "e2_p1": "Дальше была аспирантура в области ИИ и анализа данных — и преподавание в университетах.",
    ...
    "s2_facts": [
        ...
        ("fa-bolt", "Создавал <strong>ИИ-двойника энергосети</strong> для выявления потерь электроэнергии"),
        ("fa-users", "Помогал создавать <strong>тысячи виртуальных инфлюенсеров</strong>"),
        ("fa-flask", "Работал над множеством других ИИ-стартапов в разных индустриях"),
    ],
    ...
    "s3_head": "Один человек вместо команды",
    ...
    "x1_cards": [
        ...
        ("fa-bolt-lightning", "Стартапы", "Могли двигаться невероятно быстро, но из-за ограниченных "
                                          "ресурсов не каждую идею удавалось воплотить.", "o"),
    ],
    ...
    "x3_note": "Стратегия становится картой движения. Следующий этап — исполнение.",

    "x4_head": "ИИ-операционная система",
    "x4_p1": ("Сейчас я создаю <strong>ИИ-операционную систему для бизнеса</strong>, в основе которой "
